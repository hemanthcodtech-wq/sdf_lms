...
const Contact = () => {
  ...
  return (
    <div className="bg-bg-cream pb-12 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-outfit text-gray-900 mb-4">{t('contact_title')}</h1>
          <p className="text-gray-600 font-inter text-lg">{t('contact_subtitle')}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100">
          ...
          <div className="bg-brand-green p-10 md:p-12 text-white relative overflow-hidden">
            ...
            <h2 className="text-3xl font-bold font-outfit mb-8 relative z-10">{t('contact_info')}</h2>
            ...
            <div className="space-y-8 relative z-10">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-outfit text-sm text-green-100">{t('contact_call')}</p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-outfit text-sm text-green-100">{t('contact_email_us')}</p>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-outfit text-sm text-green-100">{t('contact_location_label')}</p>
                  <p className="font-inter font-semibold">{t('contact_location_val')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-10 md:p-12">
            <h3 className="text-2xl font-bold font-outfit text-gray-900 mb-6">{t('contact_send_title')}</h3>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="custom-input flex flex-col p-2 shadow-sm">
                <label className="text-[13px] font-semibold text-gray-500 ml-2 mb-1">{t('contact_name')}</label>
                <input 
                  type="text" required
                  value={formData.name}
              ...
              <div className="custom-input flex flex-col p-2 shadow-sm">
                <label className="text-[13px] font-semibold text-gray-500 ml-2 mb-1">{t('contact_email_label')}</label>
                <input 
                  type="email" required
              ...
              <div className="custom-input flex flex-col p-2 shadow-sm">
                <label className="text-[13px] font-semibold text-gray-500 ml-2 mb-1">{t('contact_message')}</label>
                <textarea 
                  required rows="4"
